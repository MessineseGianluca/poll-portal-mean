...
router.get('/polls/:id/questions/:id/options/:id', auth.hasRole('admin'), controller.showSingleQuestion);
router.post('/polls/:id/questions/:id/options', auth.hasRole('admin'), controller.createQuestion);
router.put('/polls/:id/questions/:id/options/:id', auth.hasRole('admin'), controller.updateQuestion);
router.delete('/polls/:id/questions/:id/options/:id', auth.hasRole('admin'), controller.destroyQuestion);
